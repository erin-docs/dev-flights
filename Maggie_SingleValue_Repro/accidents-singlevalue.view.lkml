view: accidents_singlevalue {
    ...
    dimension: purpose_of_flight {
      type: string
#   Original definition from autogenerated SQL
#     sql: ${TABLE}.purpose_of_flight ;;

#   Liquid that follows standard querying policy
#     sql: {% if _explore._name == "accidents" %}
#     ${TABLE}.purpose_of_flight
#     {% else %}
#     ${investigation_type}
#     {% endif %};;

#   Liquid + User Attributes that sends duplicate queries
      sql: {% if _user_attributes['first_name'] == "Margaret" %}
            ${TABLE}.purpose_of_flight
            {% else %}
            ${investigation_type}
            {% endif %};;
